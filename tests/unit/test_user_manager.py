...
class TestUserManager:  # pylint: disable=too-many-public-methods
    ...
    async def test_create_user_missing_values(self, test_db, create_data):
    ...
    async def test_login_user_not_verified(self, test_db):
    ...
    async def test_login_user_banned(self, test_db):
    ...
    # -------------------------- test set ban status ------------------------- #
    async def test_ban_user(self, test_db):
    ...
    async def test_cant_ban_user_already_banned(self, test_db, state):
    ...
    async def test_cant_ban_self(self, test_db):
    ...
    async def test_change_user_role_to_admin(self, test_db):
