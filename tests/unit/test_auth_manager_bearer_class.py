...
class TestCustomHTTPBearer:
    ...
    async def test_custom_bearer_class(self, test_db, mocker):
    ...
    async def test_custom_bearer_class_no_auth_header(self, test_db, mocker):
    ...
    async def test_custom_bearer_class_banned_user(self, test_db, mocker):
    ...
    async def test_custom_bearer_class_unverified_user(self, test_db, mocker):
        """Test with a banned user."""
    ...
    async def test_custom_bearer_expired_token(self, test_db, mocker):
